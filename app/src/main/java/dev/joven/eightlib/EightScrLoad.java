...
public class EightScrLoad extends AppCompatActivity {
    mgdUtil tools;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eight_scr_load);
        tools = EightGlobalCFG.getTools(this);
        ...
        splashUI.createSplashUI(this, EightContent.class, R.raw.loading);
    }
}